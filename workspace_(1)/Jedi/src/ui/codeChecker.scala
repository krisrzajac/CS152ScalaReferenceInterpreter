...
object codeChecker {
  def check2() {
    ...
    println(" executing literals: 100, 42, true")
    ...
    println(" executing identifiers: x, y, z")
    ...
    println("next, create & execute some funcalls: ")

    println()
    println(" executing add(x, 42)")
    ...
    println()
    println(" executing add(x, 42, add(x, 42)) ")
